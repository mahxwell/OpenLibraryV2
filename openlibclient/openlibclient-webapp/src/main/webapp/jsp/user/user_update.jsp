    ...
    <div id="content">
        ...
        <section id="mainContent">
            ...
            <div style="text-align: right; width: 250px;margin-top: 70px">
                <h3 style="text-align: center">Mettez à jour vos informations personnelles</h3>
                ...
                <input name="user.userName" type="text" class="form-control"
                       id="user.userName" placeholder="Entrer Nouveau Nom" required="required">
                </br>
                ...
                <input name="user.userSurname" type="text" class="form-control"
                       id="user.userSurname" placeholder="Entrer Nouveau Prénom" required="required"
                ...
                <input name="user.userPseudo" type="text" class="form-control"
                       id="user.userPseudo" placeholder="Entrer Nouveau Pseudo" required="required">
                </br>
                ...
                <input name="user.userEmail" type="email" class="form-control"
                       ...
                       placeholder="Entrer  Nouvelle Adresse Email">
                </br>
                ...
                <input name="user.userPassword" type="password" class="form-control"
                       id="user.userPassword" placeholder="Entrer Nouveau Mot de Passe" required="required">
                </br>
                ...
                <input name="user.userPhone" type="text" class="form-control"
                       id="user.userPhone" placeholder="Entrer Nouveau numéro téléphone" required="required">

                </br>
                </br></br></br>

                <s:submit key="Mettre à jour" theme="simple" class="btn btn-primary btn-sm"/>
                <s:a action="welcome">
