 ...
 * 
 */
@WebServiceClient(name = "user", targetNamespace = "http://user.service.openlib.mahxwell.org/", wsdlLocation = "http://DESKTOP-JQMEVRQ:8080/Openlibrary-Webservice2762372788123895464/user?wsdl")
    ...
    extends Service
{
    ...
    static {
        ...
        try {
            url = new URL("http://DESKTOP-JQMEVRQ:8080/Openlibrary-Webservice2762372788123895464/user?wsdl");
