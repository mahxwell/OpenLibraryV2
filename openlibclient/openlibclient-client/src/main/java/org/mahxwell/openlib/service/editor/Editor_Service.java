 ...
 * 
 */
@WebServiceClient(name = "editor", targetNamespace = "http://editor.service.openlib.mahxwell.org/", wsdlLocation = "http://DESKTOP-JQMEVRQ:8080/Openlibrary-Webservice2762372788123895464/editor?wsdl")
    ...
    extends Service
{
    ...
    static {
        ...
        try {
            url = new URL("http://DESKTOP-JQMEVRQ:8080/Openlibrary-Webservice2762372788123895464/editor?wsdl");
