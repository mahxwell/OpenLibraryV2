 ...
 * 
 */
@WebServiceClient(name = "reservation", targetNamespace = "http://reservation.service.openlib.mahxwell.org/", wsdlLocation = "http://Mahxwells-MacBook.local:8080/Openlibrary-Webservice6411802224659043663/reservation?wsdl")
    ...
    extends Service
{
    ...
    static {
        ...
        try {
            url = new URL("http://Mahxwells-MacBook.local:8080/Openlibrary-Webservice6411802224659043663/reservation?wsdl");
