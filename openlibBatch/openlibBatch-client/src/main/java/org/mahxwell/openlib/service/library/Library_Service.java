 ...
 * 
 */
@WebServiceClient(name = "library", targetNamespace = "http://library.service.openlib.mahxwell.org/", wsdlLocation = "http://DESKTOP-JQMEVRQ:8080/Openlibrary-Webservice2562610770408138605/library?wsdl")
    ...
    extends Service
{
    ...
    static {
        ...
        try {
            url = new URL("http://DESKTOP-JQMEVRQ:8080/Openlibrary-Webservice2562610770408138605/library?wsdl");
